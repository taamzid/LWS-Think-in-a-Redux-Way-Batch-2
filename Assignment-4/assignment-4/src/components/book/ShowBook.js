...
import deleteTodo from "../../redux/bookList/thunk/deleteBook";
import fetchTodos from "../../redux/bookList/thunk/fetchBooks";
              ...
              <div class="book-card">
                ...
                <div class="flex-1 h-full pr-2 pt-2 flex flex-col">
                  ...
                  <div class="space-y-2 mt-4 h-full">
                    <h4 class="lws-bookName">{b.name}</h4>
                    <p class="lws-author">{b.author}</p>
                    <div class="lws-stars">
                      {[...Array(b.rating)].map((s) => (
                        <svg
                          viewBox="0 0 20 20"
                          fill="currentColor"
                          class="lws-star"
